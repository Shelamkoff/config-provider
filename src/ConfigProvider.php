...
class ConfigProvider
{
    ...
    /**
     * @var ConfigProvider[] Child configuration providers
     */
     ...
     * @return class-string<T>[] Array of ConfigProvider class names
     */
    ...
    {
        return ($config = $this->getMergedConfig()) !== [] ? 
            array_replace($array = ['dependencies' => $this->getDependencies()], $config) 
            : $array;
    }

    /**
     * Get merged configuration from this provider and all child providers
     *
     * @return array Merged application configuration
     */
